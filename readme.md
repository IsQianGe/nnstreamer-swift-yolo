...
gst-launch-1.0 \
  ...
  t. ! queue leaky=2 max-size-buffers=2 ! videoscale ! \
    ...
    queue ! tensor_filter framework=swift_yolo model=net/epoch_300_float.ncnn.bin,net/epoch_300_float.ncnn.param input=320:320:3:1 inputtype=float32 output=85:6300:1:1 outputtype=float16 latency=1 ! \
    other/tensors,num_tensors=1,types=float16,dimensions=85:6300:1:1,format=static ! \
