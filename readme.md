...
gst-launch-1.0 \
  ...
  t. ! queue leaky=2 max-size-buffers=2 ! videoscale ! \
    ...
    queue ! tensor_filter framework=pytorch model=net/epoch_300_float.ncnn.bin model=net/epoch_300_float.ncnn.param input=320:320:3:1 inputtype=float32 output=85:6300:1:1 outputtype=float32 latency=1 ! \
